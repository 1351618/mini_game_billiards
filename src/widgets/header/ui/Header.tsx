...
import billiardSvg from "./billiard.svg";
import billiardLengSvg from "./billiard_leng.svg";
  ...
  return (
    <header className={cls.header}>
      ...
      <div className={cls.headerBacLang}>
        ...
        >
          {/* {t("Change language")} */}
          <img src={billiardLengSvg} alt="" />
        </button>

        {/* <button onClick={changeTheme}>{t("Change theme")}</button> */}
        <button onClick={changeTheme}>
          <img src={billiardsBcSvg} alt="" />
        </button>
      </div>
      <div
